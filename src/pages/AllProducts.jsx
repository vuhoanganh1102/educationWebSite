            ...
            <div className='sm:mx-20 mx-3 justify-center flex'>
                <form className='lg:w-[42rem] w-[32rem] max-[599px]:w-72 '>   
                    ...
                    <div class="relative">
                        ...
                        class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                         dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                         placeholder="Type Vinh or Tuan or technology ..." required /> 
                        <button
                        
                        type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-blue-700
